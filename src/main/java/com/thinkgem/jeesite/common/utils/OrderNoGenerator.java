...
/**
 * Created by houyi on 2017/5/25.
 */
public enum OrderNoGenerator {
    INSTANCE;
    ...
    /**
     * 前17位用于存储yyyyMMddHHMMssSSS格式的时间，后面用于记录所在集群，节点，以及自增量，共23位
     * @return
     */
    ...
    public static void main(String[] args) throws InterruptedException {
        final OrderNoGenerator generator = OrderNoGenerator.INSTANCE;
