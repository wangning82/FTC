 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/ftc/product/model")
public class ModelController extends BaseController {
	...
	@RequiresPermissions("ftc:product:model:view")
	@RequestMapping(value = {"list", ""})
	public String list(Product product, HttpServletRequest request, HttpServletResponse response, Model model) {
		Page<Product> page = productService.findPage(new Page<Product>(request, response), product); 
		model.addAttribute("page", page);
		return "modules/ftc/product/modelList";
	}
	...
	public String form(Product product, Model model) {
		...
		return "modules/ftc/product/modelForm";
	}

	@RequiresPermissions("ftc:product:model:edit")
	...
	public String save(Product product, Model model, RedirectAttributes redirectAttributes) {
		...
		return "redirect:"+Global.getAdminPath()+"/ftc/product/model/?repage";
	}
