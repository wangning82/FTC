...
public class OrderController extends BaseController {
	...
	@RequiresPermissions("ftc:order:order:view")
	...
	public String list(Order order, HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		return "modules/ftc/order/orderList";
	}
	...
	public String form(Order order, Model model) {
		...
		return "modules/ftc/order/orderForm";
	}

	@RequiresPermissions("ftc:order:order:edit")
	...
	public String save(Order order, Model model, RedirectAttributes redirectAttributes) {
		...
		return "redirect:"+Global.getAdminPath()+"/ftc/order/order/?repage";
	}
