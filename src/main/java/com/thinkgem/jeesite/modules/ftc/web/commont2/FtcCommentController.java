 ...
 */
package com.thinkgem.jeesite.modules.ftc.web.commont2;
...
import com.thinkgem.jeesite.modules.ftc.service.commont2.FtcCommentService;
 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/ftc/commont2/ftcComment")
public class FtcCommentController extends BaseController {
	...
	@RequiresPermissions("ftc:commont2:ftcComment:view")
	...
	public String list(FtcComment ftcComment, HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		return "modules/ftc/commont2/ftcCommentList";
	}
	...
	public String form(FtcComment ftcComment, Model model) {
		...
		return "modules/ftc/commont2/ftcCommentForm";
	}

	@RequiresPermissions("ftc:commont2:ftcComment:edit")
	...
	public String save(FtcComment ftcComment, Model model, RedirectAttributes redirectAttributes) {
		...
		return "redirect:"+Global.getAdminPath()+"/ftc/commont2/ftcComment/?repage";
	}
