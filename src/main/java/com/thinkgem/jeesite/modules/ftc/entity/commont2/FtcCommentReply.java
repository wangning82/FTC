 ...
 * @version 2017-05-19
 */
public class FtcCommentReply extends DataEntity<FtcCommentReply> {
	
	private static final long serialVersionUID = 1L;
	private FtcComment commentId;		// 评论ID 父类
	...
	public FtcCommentReply() {
		super();
	}

	public FtcCommentReply(String id){
		super(id);
	}

	public FtcCommentReply(FtcComment commentId){
		this.commentId = commentId;
	}

	@Length(min=0, max=64, message="评论ID长度必须介于 0 和 64 之间")
	public FtcComment getCommentId() {
		return commentId;
	}

	public void setCommentId(FtcComment commentId) {
		this.commentId = commentId;
	}
