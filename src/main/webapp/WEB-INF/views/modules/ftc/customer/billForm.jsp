...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/ftc/customer/bill/">账单列表</a></li>
		<li class="active"><a href="${ctx}/ftc/customer/bill/form?id=${bill.id}">账单<shiro:hasPermission name="ftc:customer:bill:edit">${not empty bill.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="ftc:customer:bill:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="bill" action="${ctx}/ftc/customer/bill/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="ftc:customer:bill:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
