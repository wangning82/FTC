...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/ftc/commont/ftcCommentReply/">回复列表</a></li>
		<li class="active"><a href="${ctx}/ftc/commont/ftcCommentReply/form?id=${ftcCommentReply.id}">回复<shiro:hasPermission name="ftc:commont:ftcCommentReply:edit">${not empty ftcCommentReply.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="ftc:commont:ftcCommentReply:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="ftcCommentReply" action="${ctx}/ftc/commont/ftcCommentReply/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="user" name="user.id" value="${ftcCommentReply.user.id}" labelName="" labelValue="${ftcCommentReply.}"
		...
		<div class="form-actions">
			<shiro:hasPermission name="ftc:commont:ftcCommentReply:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
