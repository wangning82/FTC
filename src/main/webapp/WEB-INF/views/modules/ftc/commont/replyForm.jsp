...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/ftc/commont/reply/">回复列表</a></li>
		<li class="active"><a href="${ctx}/ftc/commont/reply/form?id=${reply.id}">回复<shiro:hasPermission name="ftc:commont:reply:edit">${not empty reply.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="ftc:commont:reply:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="reply" action="${ctx}/ftc/commont/reply/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="ftc:commont:reply:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
