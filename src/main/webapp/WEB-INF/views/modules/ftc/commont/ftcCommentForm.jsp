...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/ftc/commont/ftcComment/">评论列表</a></li>
		<li class="active"><a href="${ctx}/ftc/commont/ftcComment/form?id=${ftcComment.id}">评论<shiro:hasPermission name="ftc:commont:ftcComment:edit">${not empty ftcComment.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="ftc:commont:ftcComment:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="ftcComment" action="${ctx}/ftc/commont/ftcComment/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="ftc:commont:ftcComment:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
