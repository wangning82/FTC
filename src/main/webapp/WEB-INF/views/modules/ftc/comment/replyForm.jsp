...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/ftc/comment/reply/">回复列表</a></li>
		<li class="active"><a href="${ctx}/ftc/comment/reply/form?id=${reply.id}">回复<shiro:hasPermission name="ftc:comment:reply:edit">${not empty reply.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="ftc:comment:reply:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="reply" action="${ctx}/ftc/comment/reply/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="ftc:comment:reply:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
