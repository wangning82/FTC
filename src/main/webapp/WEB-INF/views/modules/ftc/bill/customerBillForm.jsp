...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/ftc/bill/customerBill/">账单列表</a></li>
		<li class="active"><a href="${ctx}/ftc/bill/customerBill/form?id=${customerBill.id}">账单<shiro:hasPermission name="ftc:bill:customerBill:edit">${not empty customerBill.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="ftc:bill:customerBill:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="customerBill" action="${ctx}/ftc/bill/customerBill/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="ftc:bill:customerBill:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
