...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/ftc/order/osOrder/">订单列表</a></li>
		<li class="active"><a href="${ctx}/ftc/order/osOrder/form?id=${osOrder.id}">订单<shiro:hasPermission name="ftc:order:osOrder:edit">${not empty osOrder.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="ftc:order:osOrder:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="osOrder" action="${ctx}/ftc/order/osOrder/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="ftc:order:osOrder:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
