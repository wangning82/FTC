...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/ftc/advert/advert/">广告位列表</a></li>
		<li class="active"><a href="${ctx}/ftc/advert/advert/form?id=${advert.id}">广告位<shiro:hasPermission name="ftc:advert:advert:edit">${not empty advert.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="ftc:advert:advert:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="advert" action="${ctx}/ftc/advert/advert/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
